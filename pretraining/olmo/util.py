...
def filter_warnings():
    ...
    # Suppress FutureWarning from megablocks about deprecated torch.cuda.amp.custom_fwd/custom_bwd
    warnings.filterwarnings(
        action="ignore",
        category=FutureWarning,
        message=".*torch.cuda.amp.custom_.*is deprecated.*",
    )
    # Also suppress by module as backup
    warnings.filterwarnings(
        action="ignore",
        category=FutureWarning,
        module="megablocks",
